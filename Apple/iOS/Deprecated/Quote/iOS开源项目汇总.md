<center><font size="5"><b>iOS 开源项目汇总</b></font></center>

> 摘自：<https://www.jianshu.com/p/8b799e0e7c2f>

学了这么久，还是抽时间把github上比较好用的第三方总结了一下

![\color{#0000ff}{Category/Util}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7BCategory%2FUtil%7D)
...
![\color{#0000ff}{ 基础功能}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%9F%BA%E7%A1%80%E5%8A%9F%E8%83%BD%7D)
...
![\color{#0000ff}{ 框架/封装}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E6%A1%86%E6%9E%B6%2F%E5%B0%81%E8%A3%85%7D)
...
```jsx
 ...
 Bolts-iOS  低层次的，更好的管理异步任务的库，支持Facebook AppLinks(同时有Android版)    NSObject-ObjectMap JSON和XML包装到Object            
 Ejecta 通过OpenGL OpenAL来实现 WebCanvas JS等,很庞大~            
 FCModel    为SQL程序员包装一下CoreData
```

![\color{#0000ff}{ 功能/封装}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%8A%9F%E8%83%BD%2F%E5%B0%81%E8%A3%85%7D)
...
![\color{#0000ff}{ 网络基础}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E7%BD%91%E7%BB%9C%E5%9F%BA%E7%A1%80%7D)
...
![\color{#0000ff}{ JSON}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20JSON%7D)
...
![\color{#0000ff}{ XML/HTML}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20XML%2FHTML%7D)
...
![\color{#0000ff}{ 功能性}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%8A%9F%E8%83%BD%E6%80%A7%7D)
...
![\color{#0000ff}{ SDK}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20SDK%7D)
...
![\color{#0000ff}{ 音频、图像视频、OpenGL}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E9%9F%B3%E9%A2%91%E3%80%81%E5%9B%BE%E5%83%8F%E8%A7%86%E9%A2%91%E3%80%81OpenGL%7D)
...
![\color{#0000ff}{ 图像显示/解析}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%9B%BE%E5%83%8F%E6%98%BE%E7%A4%BA%2F%E8%A7%A3%E6%9E%90%7D)
...
![\color{#0000ff}{ 图像处理}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%9B%BE%E5%83%8F%E5%A4%84%E7%90%86%7D)
...
![\color{#0000ff}{ 颜色}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E9%A2%9C%E8%89%B2%7D)
...
![\color{#0000ff}{ 绘图库}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E7%BB%98%E5%9B%BE%E5%BA%93%7D)
...
![\color{#0000ff}{ 动画/效果CA}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%8A%A8%E7%94%BB%2F%E6%95%88%E6%9E%9CCA%7D)
...
![\color{#0000ff}{ 动画曲线}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%8A%A8%E7%94%BB%E6%9B%B2%E7%BA%BF%7D)
...
![\color{#0000ff}{ 常见动画}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%B8%B8%E8%A7%81%E5%8A%A8%E7%94%BB%7D)
...
![\color{#0000ff}{ 控件HUD}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E6%8E%A7%E4%BB%B6HUD%7D)
...
![\color{#0000ff}{ Slider}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Slider%7D)
...
![\color{#0000ff}{ Progress}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Progress%7D)
...
```undefined
 ...
 M13ProgressSuite   一套不同风格的Progress：包括圆形、环形、进度、蒙板等等           SpinKit-ObjC  由JS版SpinKit模仿得来，几个不错的ActivityIndicator           
```

![\color{#0000ff}{StatusBar}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7BStatusBar%7D)
...
![\color{#0000ff}{ Alert}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Alert%7D)
...
![\color{#0000ff}{ Notification}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Notification%7D)
...
![\color{#0000ff}{ Segment}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Segment%7D)
...
![\color{#0000ff}{ Switch}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Switch%7D)
...
![\color{#0000ff}{ Button}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Button%7D)
...
![\color{#0000ff}{ Label/Text/排版}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Label%2FText%2F%E6%8E%92%E7%89%88%7D)
...
![\color{#0000ff}{ PullToRefresh}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20PullToRefresh%7D)
...
HybridRefreshGestureRecognizer  一个类似似TweetBot的下拉刷新样式             
 ...
 CBStoreHouseRefreshControl Storehouse中出现的下拉效果，散开/聚拢的闪动的文字        MJRefresh 一个据说国内用得比较多的下拉刷新
```

![\color{#0000ff}{ Scroll/Table}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Scroll%2FTable%7D)
...
```objectivec
 ...
 MHPagingScrollView 一个可以Page的ScrollView 但可以看到左右的预览 类似WP7             KLScrollSelect 一个竖屏滚动的选择瀑布流             
...
![\color{#0000ff}{ Popover}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Popover%7D)
...
![\color{#0000ff}{ GridView}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20GridView%7D)
...
![\color{#0000ff}{ 界面切换/导航}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E7%95%8C%E9%9D%A2%E5%88%87%E6%8D%A2%2F%E5%AF%BC%E8%88%AA%7D)
...
MWFSlideNavigationViewController    一个能左右上下滑动的简单导航栏          
 ...
 CBHazeTransitionViewController 类似iOS6的下拉刷新的动画切换，水滴状拖拽           JTMaterialTransition   Android Material 转场效果 (圆形放大至全屏)          
...
![\color{#0000ff}{ 侧滑}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E4%BE%A7%E6%BB%91%7D)
...
![\color{#0000ff}{知名效果Demo}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%E7%9F%A5%E5%90%8D%E6%95%88%E6%9E%9CDemo%7D)
...
![\color{#0000ff}{高级功能}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%7D)
...
![\color{#0000ff}{ 套装}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%A5%97%E8%A3%85%7D)



```objectivec
 tapkulibrary   一套比较大的自定义控件库 包括不错的HUD,进度条,日历,CoverFlow等          FlatUIKit  一套完整的扁平风格的UI (Flat)          
 FlatUI 一套仿iOS7的控件           
 ...
 MGBoxKit   一套UIView的扩展和子类(Table Grid..) 有不错的类CSS的功能 有些好用的代码         MGBox  MGBox的旧版 应该去看v2          
 iOS-boilerplate    一些常见功能实现的例子:HUD Table滑动,打开URL用WebView等 挺老的工程     idev-recipes   iDevRecipes博客的代码,演示了如何自定义一些控件,代码比较老..
```

![\color{#0000ff}{ 其他}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E5%85%B6%E4%BB%96%7D)
...
![\color{#0000ff}{ 较完整的App}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E8%BE%83%E5%AE%8C%E6%95%B4%E7%9A%84App%7D)
...
```objectivec
 ...
 viewfinder Square开源了完整的viewfinder源码，包括服务端和客户端(iOS/Android) 赞！       Sol    漂亮的扁平风格的天气App            
 ChatSecure-iOS 一个XMPP客户端～ 支持Jabber/GTalk等XMPP协议             
 iOSSF  SegmentFault官方App ...            
 PlainReader    CnBeta简阅,简洁好用的CB客户端,曾上架AppStore但因版权问题被下了             ioctocat   一个Github客户端          
 ...
 origami  Facebook Paper用到的原型设计工具,是Quartz Composer插件             
 Tweaks Facebook Paper用到的界面调整小工具,可以给产品/开发自己去调整和尝试动画/颜色等  ios-snapshot-test-case Facebook 的iOS单元测试工具,通过截屏对比来实现UI测试            chisel Facebook 出的一套LLDB增强命令, 注意这是python脚本          
...
旧代码 & 奇怪的东西
 ...
 SimFinger  一些Fake系统图标的App 还有一些设备外框的图片、触摸点图片可以用          scifihifi-iphone   已经弃用的旧代码 新工程去看github页面           
...
![\color{#0000ff}{ 代码库大包包}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E4%BB%A3%E7%A0%81%E5%BA%93%E5%A4%A7%E5%8C%85%E5%8C%85%7D)
...
![\color{#0000ff}{ Mac Only}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Mac%20Only%7D)
...
![\color{#0000ff}{ Xcode插件/开发工具}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Xcode%E6%8F%92%E4%BB%B6%2F%E5%BC%80%E5%8F%91%E5%B7%A5%E5%85%B7%7D)
...
![\color{#0000ff}{ Swift基础功能}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20Swift%E5%9F%BA%E7%A1%80%E5%8A%9F%E8%83%BD%7D)
...
![\color{#0000ff}{ 框架}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E6%A1%86%E6%9E%B6%7D)
...
![\color{#0000ff}{ 网络}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E7%BD%91%E7%BB%9C%7D)
...
![\color{#0000ff}{ 控件/UI}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E6%8E%A7%E4%BB%B6%2FUI%7D)
...
```undefined
 ...
 Siren  升级时的提示弹框, (Harpy的Swift版本) 使用时需要谨慎对待AppStore审核            MusicKit   音乐分析、和弦探测、MIDI I/O
```

![\color{#0000ff}{ App}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20App%7D)
...
![\color{#0000ff}{ 非Github}](https://math.jianshu.com/math?formula=%5Ccolor%7B%230000ff%7D%7B%20%E9%9D%9EGithub%7D)
...
作者：HookLee
链接：https://www.jianshu.com/p/8b799e0e7c2f
来源：简书
