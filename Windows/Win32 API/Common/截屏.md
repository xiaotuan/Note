...
int main(void) {
    ...
    screenX = GetDeviceCaps(hdc, DESKTOPHORZRES);
    screenY = GetDeviceCaps(hdc, DESKTOPVERTRES);
    std::cout << "Real screen x:" << screenX << ", y: " << screenY << std::endl;
    ...
    SaveBitmapToFile(TEXT("C:\\WorkSpace\\screenshot.bmp"), hBitmap);
