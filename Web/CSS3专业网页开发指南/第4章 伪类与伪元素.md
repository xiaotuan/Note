...
这段标记包含了描述文档树中每个元素位置的类名：first（<img class="my_markdown" src="./images/96.jpg" style="width:35px;  height: 34px; " width="20"/>）和last（<img src="https://cdn.ptpress.cn/pubcloud/5B0A982E/ushu/N8506/online/FBOL6c694c89d077c/Images/97.jpg" style="width:33px;  height: 33px; " width="20"/>）表明li元素是ul元素的第一个和最后一个子元素，而odd（<img src="https://cdn.ptpress.cn/pubcloud/5B0A982E/ushu/N8506/online/FBOL6c694c89d077c/Images/98.jpg" style="width:35px;  height: 35px; " width="20"/>）则用于第奇数个li元素。附加的span（<img src="https://cdn.ptpress.cn/pubcloud/5B0A982E/ushu/N8506/online/FBOL6c694c89d077c/Images/99.jpg" style="width:33px;  height: 33px; " width="20"/>）则围绕在第一个li元素的第一个字母外围。
