...
最先展示的是参照的例子；这个参照是从默认点center center查看的变换元素。第二个例子（<img class="my_markdown" src="./images/626.jpg" style="width:35px;  height: 34px; " width="20"/>）是同一个元素，但是perspective-origin是在元素左手边的中心。你可以在图14-1中的第二个例子清晰地看到，你所查看的元素角度已经发生了变化，观察点出现在稍微偏左的位置。图中的第三个例子（<img src="https://cdn.ptpress.cn/pubcloud/5B0A982E/ushu/N8506/online/FBOL6c694c89d077c/Images/627.jpg" style="width:35px;  height: 35px; " width="20"/>），我使用了长度值128px 56px，将起点改为右手边的底部。这一次观察点出现在稍微偏右并向上仰望的位置。最后（最右端）一个例子（<img src="https://cdn.ptpress.cn/pubcloud/5B0A982E/ushu/N8506/online/FBOL6c694c89d077c/Images/628.jpg" style="width:33px;  height: 33px; " width="20"/>）是从x 轴上75%和y 轴上25%的点去查看，有点类似于参照的例子，但是其观察点已经稍微移到元素的右边向上一点的位置。
