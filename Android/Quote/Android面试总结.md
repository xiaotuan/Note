<center><font size="5"><b>Android面试总结</b></font></center>

> 摘自：<https://mp.weixin.qq.com/s?__biz=MzI3OTU0MzI4MQ==&mid=2247485938&idx=1&sn=c5d96ed6357be1be87a64aab70142c1a&chksm=eb47656cdc30ec7aaf898b0fd06b0f59629e02d7df0609ed3337095fe1fed6648896d43edd7a&scene=21#wechat_redirect>

![img](https://mmbiz.qpic.cn/mmbiz_png/CvQa8Yf8vq2ModBGqVxa7TYTU9UVmaVD1CQLdrCFnLjp5I1ibrIAsQvT2LdSq2B0RfxEluIjMP3zAOqiaP8zIahA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/CvQa8Yf8vq2ModBGqVxa7TYTU9UVmaVDvG0tJnPqzVmm7zv210IeCHu5l8UEfGJrGFkVhPhYkkmoeS6KxQJaGQ/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

从上图可知，JVM主要包括四个部分：

1.类加载器（ClassLoader）:在JVM启动时或者在类运行时将需要的class加载到JVM中。（下图表示了从java源文件到JVM的整个过程，可配合理解。

![img](https://mmbiz.qpic.cn/mmbiz_jpg/CvQa8Yf8vq2ModBGqVxa7TYTU9UVmaVD7X1YJatANQ8mTe0ZybawCGHibR8YhPjTckzzToJibILJX0k4IO0lK7Og/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

2.执行引擎：负责执行class文件中包含的字节码指令；

3.内存区（也叫运行时数据区）：是在JVM运行的时候操作所分配的内存区。运行时内存区主要可以划分为5个区域，如图：

![img](https://mmbiz.qpic.cn/mmbiz_jpg/CvQa8Yf8vq2ModBGqVxa7TYTU9UVmaVD7U2UncT32WYiczqqMpA8sjPSXAAloLEjAq8w0eGlzNzJHZE45MErGew/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/CvQa8Yf8vq2ModBGqVxa7TYTU9UVmaVDRichb0hXqibwnxmv5L8WGRD8zNz3If7FkFJzVAGtgJXKYGibUnsjickIzQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/CvQa8Yf8vq2ModBGqVxa7TYTU9UVmaVDDcYMH3xL67VUDVDy50rNLbp2pH0V8Ch3UlRYXTpNt4FCJUGNGkW88w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
参考[Android开发——Android中常见的4种线程池（保证你能看懂并理解）(http://blog.csdn.net/seu_calvin/article/details/52415337)) ]
