...
修改 `vnd/vendor/mediatek/proprietary/hardware/meta/adaptor/storageutil/mounts.c` 文件中 `// Allows customer tools to perform factory Settings restoration by qty {{&&` 标识的代码：
