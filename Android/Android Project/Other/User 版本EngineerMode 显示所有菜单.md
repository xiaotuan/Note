...
1. 修改 `vendor/mediatek/proprietary/packages/apps/EngineerMode/Android.mk` 文件代码如下：
...
2. 修改 `vendor/mediatek/proprietary/packages/apps/EngineerMode/src/com/mediatek/engineermode/FeatureSupport.java` 文件代码如下：
