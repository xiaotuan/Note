...
> 内联类仅在 Kotlin 1.3 之后版本可用，目前还是*实验性的*。关于详情请参见[下文](https://www.kotlincn.net/docs/reference/inline-classes.html#内联类的实验性状态)
...
关于详细信息，请参见[编译器选项](https://www.kotlincn.net/docs/reference/using-gradle.html#编译器选项)。关于[多平台项目](https://www.kotlincn.net/docs/reference/whatsnew13.html#多平台项目)的设置，请参见[使用 Gradle 构建多平台项目](https://www.kotlincn.net/docs/reference/building-mpp-with-gradle.html#语言设置)章节。
