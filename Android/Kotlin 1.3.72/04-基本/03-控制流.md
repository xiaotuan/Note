...
参见 [*if* 语法](https://www.kotlincn.net/docs/reference/grammar.html#ifExpression)。
...
参见 [*when* 语法](https://www.kotlincn.net/docs/reference/grammar.html#whenExpression)。
...
参见 [*while* 语法](https://www.kotlincn.net/docs/reference/grammar.html#whileStatement).

## 循环中的 Break 与 continue

在循环中 Kotlin 支持传统的 *break* 与 *continue* 操作符。参见[返回与跳转](https://www.kotlincn.net/docs/reference/returns.html)。