<center><font size="5"><b>基本语法</b></font></center>
...
'[java.lang.Object@681a9515]' string length is ... err, not a string
```
...
fun main() {
	fun printLength(obj: Any) {
		println("'$obj' string length is ${getStringLength(obj) ?: "... err, is emptyor not a string at all"} ")
	}
	printLength("Incomprehensibilities")
	printLength("")
	printLength(1000)
...
在 `Eclipse` 中无法运行，无法调用` Java` 中的 `Math` 类方法。
