...
为了在接收者类型表达式中使用泛型，我们要在函数名前声明泛型参数。 参见[泛型函数](https://www.kotlincn.net/docs/reference/generics.html)。
...
更多信息参见[导入](https://www.kotlincn.net/docs/reference/packages.html#导入)
...
扩展的可见性与相同作用域内声明的[其他实体的可见性](https://www.kotlincn.net/docs/reference/visibility-modifiers.html)相同。例如：
