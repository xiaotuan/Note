...
- [介绍](https://flutterchina.club/assets-and-images/#介绍)
- 指定 assets
  - [Asset 变体（variant）](https://flutterchina.club/assets-and-images/#asset-变体variant)
- 加载 assets
  - [加载文本assets](https://flutterchina.club/assets-and-images/#加载文本assets)
  - 加载 images
    - [声明分辨率相关的图片 assets](https://flutterchina.club/assets-and-images/#resolution-aware)
    - [加载图片](https://flutterchina.club/assets-and-images/#加载图片)
  - 依赖包中的资源图片
    - [打包 package assets](https://flutterchina.club/assets-and-images/#打包-package-assets)
- 平台 assets
  - 更新app 图标
