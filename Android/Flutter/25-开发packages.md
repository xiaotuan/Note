...
- Developing Dart packages
  - [Step 1: 开发Dart包](https://flutterchina.club/developing-packages/#step-1-开发dart包)
  - [Step 2: 实现package](https://flutterchina.club/developing-packages/#step-2-实现package)
- 开发插件包
  - [Step 1: 创建 package](https://flutterchina.club/developing-packages/#step-1-创建-package)
  - Step 2: 实现包 package
    - [Step 2a: 定义包API（.dart）](https://flutterchina.club/developing-packages/#step-2a-定义包apidart)
    - [Step 2b: 添加Android平台代码（.java / .kt）](https://flutterchina.club/developing-packages/#step-2b-添加android平台代码java--kt)
    - [Step 2c: 添加iOS平台代码 (.h+.m/.swift)](https://flutterchina.club/developing-packages/#step-2c-添加ios平台代码-hmswift)
    - [Step 2d: 连接API和平台代码](https://flutterchina.club/developing-packages/#step-2d-连接api和平台代码)
- 添加文档
...
- 处理包的相互依赖
  ...
  - [解决冲突](https://flutterchina.club/developing-packages/#解决冲突)
