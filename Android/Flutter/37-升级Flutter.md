...
我们强烈建议跟踪flutter的`stable`分支，这是Flutter稳定分支。 如果你需要查看最新的变化，你可以跟踪`master`分支，但注意这是开发分支，所以稳定性要低得多。
...
我们向我们的[邮件列表](https://groups.google.com/forum/#!forum/flutter-dev)发布重大更新公告 。 我们强烈建议您订阅我们的通知。另外，我们很乐意听取您的意见！