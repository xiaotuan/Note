...
- 哪种JSON序列化方法适合我？
  - [小项目手动序列化](https://flutterchina.club/json/#小项目手动序列化)
  - [在大中型项目中使用代码生成](https://flutterchina.club/json/#在大中型项目中使用代码生成)
- [Flutter中是否有GSON / Jackson / Moshi？](https://flutterchina.club/json/#flutter中是否有gson--jackson--moshi)
- 使用 dart:convert手动序列化JSON
  - [内连序列化JSON](https://flutterchina.club/json/#内连序列化json)
  - [在模型类中序列化JSON](https://flutterchina.club/json/#在模型类中序列化json)
- 使用代码生成库序列化JSON
  - [在项目中设置json_serializable](https://flutterchina.club/json/#在项目中设置json_serializable)
  - [以json_serializable的方式创建model类](https://flutterchina.club/json/#以json_serializable的方式创建model类)
  - 运行代码生成程序
    - [一次性生成](https://flutterchina.club/json/#一次性生成)
    - [持续生成](https://flutterchina.club/json/#持续生成)
  - [使用json_serializable模型](https://flutterchina.club/json/#使用json_serializable模型)
- [一些参考](https://flutterchina.club/json/#一些参考)
