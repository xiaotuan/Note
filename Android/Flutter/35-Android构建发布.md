...
- [检查 App Manifest](https://flutterchina.club/android-release/#检查-app-manifest)
- [查看构建配置](https://flutterchina.club/android-release/#查看构建配置)
- [添加启动图标](https://flutterchina.club/android-release/#添加启动图标)
- app签名
  - [创建 keystore](https://flutterchina.club/android-release/#创建-keystore)
  - [引用应用程序中的keystore](https://flutterchina.club/android-release/#引用应用程序中的keystore)
  - [在gradle中配置签名](https://flutterchina.club/android-release/#在gradle中配置签名)
- 开启混淆
  - [配置混淆](https://flutterchina.club/android-release/#配置混淆)
  - [开启混淆/压缩](https://flutterchina.club/android-release/#开启混淆压缩)
- [构建一个发布版（release）APK](https://flutterchina.club/android-release/#构建一个发布版releaseapk)
- [在设备上安装发行版APK](https://flutterchina.club/android-release/#在设备上安装发行版apk)
- [将APK发布到Google Play商店](https://flutterchina.club/android-release/#将apk发布到google-play商店)
...
将应用的release版发布到Google Play商店的详细说明，请参阅 [Google Play publishing documentation](https://developer.android.com/distribute/googleplay/start.html). (国内不存在的，但你可以发布到国内的各种应用商店)