...
![the custom widget you'll create](./images/favorited-not-favorited.png)
...
![a large green box with the text, 'Active'](./images/tapbox-active-state.png) ![a large grey box with the text, 'Inactive'](./images/tapbox-inactive-state.png)
