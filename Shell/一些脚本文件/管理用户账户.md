删除账户在管理账户工作中比较复杂。在删除账户时，至少需要 4 个步骤：
...
function process_answer {
    ...
    y|Y|YES|yes|Yes|yEs|yeS|YEs|yES)
        ...
        ;;
    *)
        # If user answers anything bu "yes", exit script
        echo
        echo $EXIT_LINE1
        echo $EXIT_LINE2
        echo
...
0)	# Processes running for this User Account.
	...
	y|Y|YES|yes|Yes|yEs|yeS|YEs|yES)	# If user answers "yes",
		...
		#
		# Create command to kill process in variable, COMAND_3
