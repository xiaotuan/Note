...
> <img class="my_markdown" src="./images/59.png" style="width:99px;  height: 131px; " width="10%"/>
> **使用Logging模块**
...
> <img class="my_markdown" src="./images/60.png" style="width:99px;  height: 131px; " width="10%"/>
> **Process和Stream**
