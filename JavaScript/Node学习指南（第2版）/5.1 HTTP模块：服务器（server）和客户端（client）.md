...
> <img class="my_markdown" src="./images/63.png" style="width:99px;  height: 131px; " width="10%"/>
> **HTTP的内部结构**
...
> <img class="my_markdown" src="./images/64.png" style="width:99px;  height: 131px; " width="10%"/>
> **可读和可写流**
> 第6章会讲到可读和可写流。
