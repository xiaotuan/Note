...
[![单文件组件的示例 (点击查看文本版的代码](./images/vue-component.png)](https://codesandbox.io/s/github/vuejs/vuejs.org/tree/master/src/v2/examples/vue-20-single-file-components)
...
[![带预处理器的单文件组件的示例 (点击查看文本版的代码)](./images/vue-component-with-preprocessors.png)](https://gist.github.com/chrisvfritz/1c9f2daea9bc078dcb47e9a82e5f7587)
